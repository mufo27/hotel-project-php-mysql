<?php 
    ...
    if(isset($_GET['check_pay'])){
        ...
        $rs_id = $_GET['check_pay'];

        $select = $conn->prepare("SELECT * FROM payment WHERE rs_id = :rs_id ");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">การชำระเงินค่าห้องพัก</li>
        ...
        <div class="card-body p-0">
          ...
          <div class="row mt-5">
              ...
              <div class="col-10">
                  ...
                  <?php } ?>
                  <h2 class="mt-5">เลขที่การจอง : <?= $row['rs_id'];?></h2>
                  <h2>เลขที่ใบชำระเงิน : <?= $row['pm_id'];?></h2>
                  <h2>ช่องทางการชำระเงิน : ผ่าน <?= $show;?></h2>
