                ...
                <table id="mytable" class="table table-striped projects">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 10%">วันทีจอง</th>
                            ...
                            <th class="text-center" style="width: 7%">เช็คอิน</th>
                            <th class="text-center" style="width: 7%">เช้คเอาท์</th>
                            <th class="text-center" style="width: 7%">รวมยอดชำระ</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= DateThai1($row['date_reserve']); ?></td>
